...
enum TreatCatalog {
    static let all: [Treat] = [
        Treat(id: "berry", name: "Sweet berry", lift: 15, duration: 1 * 3600, durationText: "~1 hr", cost: 15),
        Treat(id: "latte", name: "Matcha latte", lift: 16, duration: 2 * 3600, durationText: "~2 hr", cost: 22),
        Treat(id: "dango", name: "Dango", lift: 18, duration: 3 * 3600, durationText: "~3 hr", cost: 30),
        Treat(id: "cupcake", name: "Cupcake", lift: 20, duration: 6 * 3600, durationText: "~6 hr", cost: 55),
    ]
